...
kml_dict["week-day-route-2"] = new google.maps.KmlLayer(kmlRoot + 'r2.week.day.kml');
kml_dict["week-day-route-4"] = new google.maps.KmlLayer(kmlRoot + 'r4.week.day.kml');
kml_dict["week-day-route-5"] = new google.maps.KmlLayer(kmlRoot + 'r5.week.day.kml');
kml_dict["week-day-route-6"] = new google.maps.KmlLayer(kmlRoot + 'r6.week.day.kml');
kml_dict["week-day-route-8"] = new google.maps.KmlLayer(kmlRoot + 'r8.week.day.kml');
kml_dict["week-day-route-9"] = new google.maps.KmlLayer(kmlRoot + 'r9.week.day.kml');
kml_dict["week-day-route-11"] = new google.maps.KmlLayer(kmlRoot + 'r11.week.day.kml');
kml_dict["week-day-route-12"] = new google.maps.KmlLayer(kmlRoot + 'r12.week.day.kml');
kml_dict["week-day-route-13"] = new google.maps.KmlLayer(kmlRoot + 'r13.week.day.kml');
kml_dict["week-day-route-15"] = new google.maps.KmlLayer(kmlRoot + 'r15.week.day.kml');
kml_dict["week-day-route-16"] = new google.maps.KmlLayer(kmlRoot + 'r16.week.day.kml');
kml_dict["week-day-route-18"] = new google.maps.KmlLayer(kmlRoot + 'r18.week.day.kml');
kml_dict["week-day-route-26"] = new google.maps.KmlLayer(kmlRoot + 'r26.week.day.kml');
kml_dict["week-ngt-route-36"] = new google.maps.KmlLayer(kmlRoot + 'r36.week.ngt.kml');
kml_dict["week-ngt-route-38"] = new google.maps.KmlLayer(kmlRoot + 'r38.week.ngt.kml');
kml_dict["week-ngt-route-41"] = new google.maps.KmlLayer(kmlRoot + 'r41.week.ngt.kml');
kml_dict["week-ngt-route-46"] = new google.maps.KmlLayer(kmlRoot + 'r46.week.ngt.kml');
kml_dict["week-ngt-route-51"] = new google.maps.KmlLayer(kmlRoot + 'r51.week.ngt.kml');
kml_dict["week-ngt-route-52"] = new google.maps.KmlLayer(kmlRoot + 'r52.week.ngt.kml');
kml_dict["week-day-route-170"] = new google.maps.KmlLayer(kmlRoot + 'r170.week.day.kml');
tc_day_arrive_map = new google.maps.KmlLayer(kmlRoot + 'tc.day.arrive.kml');
tc_day_depart_map = new google.maps.KmlLayer(kmlRoot + 'tc.day.depart.kml');
tc_ngt_arrive_map = new google.maps.KmlLayer(kmlRoot + 'tc.ngt.arrive.kml');
tc_ngt_depart_map = new google.maps.KmlLayer(kmlRoot + 'tc.ngt.depart.kml');
